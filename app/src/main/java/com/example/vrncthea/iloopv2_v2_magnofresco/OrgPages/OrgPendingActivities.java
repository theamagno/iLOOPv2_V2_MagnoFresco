...
public class OrgPendingActivities extends ListActivity {
    ...
    private static String url_all_pending_activities = "http://theamagno.000webhostapp.com/php/get_all_pending_org_activities.php";
...
//        });
    ...
    class LoadAllActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OrgPendingActivities.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            OrgPendingActivities.this, activitiesList,

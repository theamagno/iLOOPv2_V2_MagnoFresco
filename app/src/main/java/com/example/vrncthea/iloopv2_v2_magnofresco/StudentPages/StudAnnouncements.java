...
import com.example.vrncthea.iloopv2_v2_magnofresco.AdminPages.CreateAnnouncement;
import com.example.vrncthea.iloopv2_v2_magnofresco.AdminPages.UpdateAnnouncement;
...
public class StudAnnouncements extends ListActivity {
    ...
    private static String url_all_announcements = "http://theamagno.000webhostapp.com/php/get_all_announcements.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stud_announcements);
...
//        });
    ...
    class LoadAllAnnouncements extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(StudAnnouncements.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_announcements, "GET", params);

            // Check your log cat for JSON reponse
            Log.d("All Announcements: ", json.toString());
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    users = json.getJSONArray(TAG_ANNOUNCEMENTS);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            StudAnnouncements.this, announcementsList,
                            R.layout.list_announcements, new String[] {
                            TAG_ID,
                            TAG_TITLE,
                            TAG_POSTEDBY,
                            TAG_TIMEPOSTED,

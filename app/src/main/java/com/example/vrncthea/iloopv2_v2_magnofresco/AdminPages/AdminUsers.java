...
public class AdminUsers extends ListActivity {
    ...
    private static String url_all_admins = "http://theamagno.000webhostapp.com/php/get_all_admin.php";
    ...
    class LoadAllUsers extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_admins, "GET", params);

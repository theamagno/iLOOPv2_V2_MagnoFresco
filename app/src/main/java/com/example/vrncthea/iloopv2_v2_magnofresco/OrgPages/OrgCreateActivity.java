...
import com.example.vrncthea.iloopv2_v2_magnofresco.AdminPages.Activities;
...
public class OrgCreateActivity extends AppCompatActivity {
    ...
    class CreateNewActivity extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OrgCreateActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent i = new Intent(getApplicationContext(), OrgViewActivities.class);
                    startActivity(i);

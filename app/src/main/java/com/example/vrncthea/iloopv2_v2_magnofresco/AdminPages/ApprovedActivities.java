...
public class ApprovedActivities extends ListActivity {
    ...
    private static String url_all_approved_activities = "http://theamagno.000webhostapp.com/php/get_all_approved_activities.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approved_activities);
    ...
    class LoadAllActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ApprovedActivities.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_approved_activities, "GET", params);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < users.length(); i++) {
                        ...
                        String chosenLocation = c.getString(TAG_CHOSENLOCATION);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ApprovedActivities.this, activitiesList,

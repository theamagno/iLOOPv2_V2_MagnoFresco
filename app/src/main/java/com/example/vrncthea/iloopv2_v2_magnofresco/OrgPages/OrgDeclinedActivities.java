...
public class OrgDeclinedActivities extends ListActivity {
    ...
    private static String url_all_declined_org_activities = "http://theamagno.000webhostapp.com/php/get_all_declined_org_activities.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_declined_activities);
...
//        });
    ...
    class LoadAllActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OrgDeclinedActivities.this);
            pDialog.setMessage("Loading Declined Activities. Please wait...");
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_declined_org_activities, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            OrgDeclinedActivities.this, activitiesList,

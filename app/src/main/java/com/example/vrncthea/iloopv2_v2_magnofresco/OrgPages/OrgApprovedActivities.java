...
import com.example.vrncthea.iloopv2_v2_magnofresco.AdminPages.AdminUsers;
...
import com.example.vrncthea.iloopv2_v2_magnofresco.AdminPages.UpdateUser;
...
public class OrgApprovedActivities extends ListActivity {
    // Progress Dialog
    ...
    private static String url_org_approved_activities = "http://theamagno.000webhostapp.com/php/get_all_approved_org_activities.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_approved_activities);
        ...
        new LoadApprovedActivities().execute(username);
...
//        });
     ...
     */
    class LoadApprovedActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OrgApprovedActivities.this);
            pDialog.setMessage("Loading approved activities. Please wait...");
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_org_approved_activities, "GET", params);

            // Check your log cat for JSON reponse
            Log.d("Approved Activities: ", json.toString());
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent i = new Intent(getApplicationContext(),
                            OrgViewActivities.class);
                    // Closing all previous activities
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    Toast.makeText(getApplicationContext(), "No Approved Activities.", Toast.LENGTH_LONG).show();
                    startActivity(i);
                }
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            OrgApprovedActivities.this, activitiesList,

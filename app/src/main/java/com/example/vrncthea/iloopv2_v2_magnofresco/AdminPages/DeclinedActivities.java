...
public class DeclinedActivities extends ListActivity {
    ...
    private static String url_all_declined_activities = "http://theamagno.000webhostapp.com/php/get_all_declined_activities.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declined_activities);
    ...
    class LoadAllActivities extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DeclinedActivities.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_declined_activities, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            DeclinedActivities.this, activitiesList,
